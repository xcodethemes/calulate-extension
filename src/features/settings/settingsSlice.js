...
export const settingsSlice = createSlice({
  ...
  initialState: {
    ...
    webSection: {
      qty:"#mat-dialog-0 > app-miniplaceorder > div > div > div > form > div.widget.pl-3.pr-3.pb-3.borderNone.alertContainer.ng-tns-c2870831140-25 > div > div > div > div > div:nth-child(1) > div.numberinputcontainer.mt-4.ng-tns-c2870831140-25 > div > input",
      livePrice: "",
      superTab: "",
      ...
      limitPrice: "#mat-dialog-0 > app-miniplaceorder > div > div > div > form > div.widget.pl-3.pr-3.pb-3.borderNone.alertContainer.ng-tns-c2870831140-25 > div > div > div > div > div:nth-child(1) > div.mt-4.ml16.ng-tns-c2870831140-25 > div > input",
